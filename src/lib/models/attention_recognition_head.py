...
class AttentionRecognitionHead(nn.Module):
  ...
  """
  def __init__(self, num_classes, in_planes, sDim, attDim, max_len_labels, use_cuda):
...
#  def __init__(self, sDim, xDim, yDim, attDim):
  def __init__(self, sDim, xDim, yDim, attDim, use_cuda):
...
#    yProj = self.tgt_embedding(yPrev.long().cuda())
